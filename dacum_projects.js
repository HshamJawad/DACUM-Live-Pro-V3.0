...
export function initProjectsSidebar() {
  ...
  // Keep toggle pinned on scroll/resize
  window.addEventListener('resize', _positionToggle);
  window.addEventListener('scroll', _positionToggle, { passive: true });
}
...
/* ── Toggle button — fixed, on the right edge of sidebar ── */
.dps-toggle {
  position: fixed;
  top: 50%;
