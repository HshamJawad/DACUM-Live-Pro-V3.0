    ...
    <div class="dps-search-wrap">
      <div class="dps-search-box">
        <svg class="dps-search-icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="8.5" cy="8.5" r="5" stroke="#6c7086" stroke-width="1.5"/>
          <line x1="12.5" y1="12.5" x2="16" y2="16" stroke="#6c7086" stroke-width="1.5" stroke-linecap="round"/>
        </svg>
...
.dps-search {
  width: 100%;
  padding: 6px 10px 6px 30px;   /* left room for icon */
  border-radius: 8px;
