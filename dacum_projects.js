...
function _toggleSidebar() {
  ...
  if (btn) {
    ...
    btn.style.left  = collapsed ? '48px' : '260px';
  }
}

/** Call once after sidebar is inserted to set initial toggle position. */
function _positionToggle() {
  const btn = document.getElementById('dpsToggle');
  if (btn) btn.style.left = '260px';  // default = expanded width
}
