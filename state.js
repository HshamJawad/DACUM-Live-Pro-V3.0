...
// ============================================================
// Exports:
//   AppState      — the single mutable state object (all features)
//   StateManager  — wrapper used by history.js / renderer.js
//   state         — alias for AppState (backward compat)
// ============================================================

export const AppState = {

    // ── Duties & Tasks (primary data model) ──────────────────
    duties: [],
    dutyCount: 0,
    taskCounts: {},
